const root10 = document.getElementById("older-post");
...
function renderContent() {
  root10.innerHTML = ""; // Clear previous content
  ...
  for (let i = startIndex; i < endIndex; i++) {
    ...
    root10.appendChild(el.firstElementChild);
  }

  // Calculate total pages again based on filtered apps
