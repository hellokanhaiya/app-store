...
const filteredApps = apps.filter((app) => {
  return (
    app.genreId === "GAME_ACTION" ||
    app.genreId === "GAME_BOARD" ||
    app.genreId === "GAME_PUZZLE" ||
    app.genreId === "GAME_ARCADE" ||
    app.genreId === "GAME_ADVENTURE" ||
    app.genreId === "GAME_BOARD" ||
    app.genreId === "GAME_CARD" ||
    app.genreId === "GAME_CASINO" ||
    app.genreId === "GAME_CASUAL" ||
    app.genreId === "GAME_EDUCATIONAL" ||
    app.genreId === "GAME_ROLE_PLAYING" ||
    app.genreId === "GAME_MUSICL" ||
    app.genreId === "GAME_WORD"
  );
});
